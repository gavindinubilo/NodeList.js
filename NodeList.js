( function( undefined ) {
	...
	function NodeList( args, method ) {
		var nodes, i, l;
		if( args[0] instanceof Array || args[0] instanceof NodeList ) {
	...
	[ 'querySelectorAll', 'getElementsByName', 'getElementsByClassName', 'getElementsByTagName' ]
	.forEach(function( methodName ) {
		var oldMethod = document[ methodName ].bind( document );
		document[ methodName ] = function() {
			return new NodeList( arguments, oldMethod );
		}
		document[ methodName ].NL = NL;
	});
} )( undefined );
